...
<!-- an invisible input field that will change to be the id of the the selected city in select list and will be sent with post method when the script is run-->
