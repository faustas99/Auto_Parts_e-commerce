...
<h1>Tweets About Shanghai and Points of Interest</h1>
...
<?php
        ...
        $getfield = '?q=Shanghai+OR#Shanghai+OR#Bund+OR#TheBund+OR#BundWaterfront+OR#PropagandaArts+OR#PropagandaArtCentre+OR#PropagandaCentre+OR#Qibao+OR#QibaoShanghai+OR#QibaoWatertown+OR#YuGarden+OR#YuGardens+OR#YuGardenShanghai+OR#Nanjing+OR#NanjingRoad+OR#NanjingShanghai+OR#NanjingJiangsu+OR#ShanghaiFC+OR#ShanghaiSIPGFC+OR#SIPGFC+OR#ShanghaiFootball';
        $requestMethod = 'GET';
...
<?php
        ...
        $sql = "SELECT * FROM fet18000990.shanghai_tweets ORDER BY tweet_id DESC LIMIT 1";
...
<h1>Add Your Own Comment</h1>
    ...
    <form action="shanghai_tweets.php" method="POST">
         <div class="row">
            <div class="col-25">
...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO fet18000990.shanghai_tweets VALUES  ('fet18000990.shanghai_tweets.tweet_id', '$username', '$comment');";
        $result = mysqli_query($connect,$sql);
    }
