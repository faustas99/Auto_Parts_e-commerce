	...
	<div class="products">
		...
		<div class="col-md-4 products-left">
			...
			<div class="col-md-8 products-right">
				...
				<form action = "/Auto_Parts/web/personalcare.php" method = "GET">
         		Age: <input type = "submit" name = "item"  value="M1 Door"/>
         		<input type = "text" value="<?php if(isset($_GET['item'])){echo $_GET['item'];}else{echo 0;}?>"/>
      			</form>
