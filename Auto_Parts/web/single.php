...
$sqlcategory= "SELECT * FROM items WHERE item_name='$selected_item'";    
	...
	<div class="products">
		<div class="container">
			<div class="agileinfo_single">
                ...
                <?php echo "<img src='data:image/png;base64,".base64_encode($items[0]['image'] )."'". " title='".$items[0]['item_name'] ."'"."' class='img-responsive'  />";?>
				</div>
				...
				<h2><?=$items[0]['item_name']?></h2>
					...
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
                            <h4 class="m-sing"><?=$items[0]['price']?>$</h4>
						</div>
						<h4>Stock: 12</h4>
