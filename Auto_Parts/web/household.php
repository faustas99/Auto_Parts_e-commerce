...
<?php
    ...
    $sql= "SELECT id, brand_name FROM manufacturer";    
		...
		<div class="container">
			<div class="col-md-4 products-left">
				<div class="categories">
					<h2>Categories</h2>
					<ul class="cate">
						<li><a><i class="fa fa-arrow-right" aria-hidden="true"></i>1 Series</a></li>
							<ul>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>M1</a></li>
								<li><a href="bmw_81.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>F81</a></li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>F82</a></li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>F40</a> </li>
							</ul>
